  ...
  if [ "$expected_rgb" = "rendered" ]; then
    ...
    case "$page" in
      ...
      authoritative_create_comment_proof.html)
        ...
        ;;
      authoritative_character_data_proof.html)
        marker="RESULT characterData v45 PASS text=Hello"
        ;;
      authoritative_character_data_substring_proof.html)
        marker="RESULT characterData substring v46 PASS text=Hello"
        ;;
